...
NUM_AGENTS = st.number_input("Number of agents", min_value=1, value=32, step=1)
...
def generate_circle_shape(num_agents):
    ...
    # This ensures they get more favorable positions in the formation
...
# Set the title once
containers['title'].title("Agent Formation Control - Circle")
...
def initialize_agents(num_agents):
    ...
    # Generate target positions (CHANGED: use circle formation)
